...
function Home() {
  return (
    <div className="flex flex-col space-y-10 bg-gradient-to-b from-blue-900 via-blue-500 to-blue-200 min-h-screen text-white justify-center items-center">
      <Navbar />
      <div className="flex justify-center items-center mx-5 space-x-8">
        <div className=" flex flex-col justify-center items-center space-y-4 ">
          <h1 className="font-extrabold text-5xl md:text-6xl text-center text-black">
            Code Here.{" "}
